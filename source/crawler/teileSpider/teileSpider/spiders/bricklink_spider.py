...
class BrickLinkSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        driver.get("https://store.bricklink.com/generationbrick?p=generationbrick#/shop?o={%22itemType%22:%22P%22,%22catID%22:%223%22,%22showHomeItems%22:0}")

        time.sleep(1)
        categories = driver.find_element(By.XPATH,"/html/body/div[2]/div[3]/div/aside/div/div/div[2]/section/div/div[2]/div[2]/div/div[1]")\

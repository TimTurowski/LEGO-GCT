...
\Roman{2}. Bauanleitung soll mit OCR auslesbar sein \newline
\Roman{3}. Preisvergleich sollte gegeben zwischen Einzelteilen und Sets \newline
\Roman{4}. Grafische Weboberfläche \newline
\Roman{5}. Es soll möglich sein Benutzeraccounts anzulegen und diese verwalten zu können. \newline
\Roman{6}. 3 feste Händler sollen berücksichtigt werden \newline
\Roman{7}. Auf nicht verfügbare Einzelteile sollte hingewiesen werden \newline
\Roman{8}. Lieferkosten berücksichtigen \newline 
\Roman{9}. Bei Ausgabe soll eine Verlinkung zum Produkt angezeigt werden, Bauteile sollten aufgelistet werden, Stückliste \newline
